    ...
    <div class="card-body">
        ...
        <form method="POST"
            ...
            <div class="form-group">
                ...
                <input type="url" class="form-control" name="link" id="link" placeholder="Enter Banner Link..."
                    value="{{ isset($banner) ? $banner->link : old('link') }}" required>
                @error('link')
                <span class="text-danger"><strong>{{ $message }}</strong></span>
                @enderror
            </div>
            ...
            <div class="form-group">
                ...
                <select class="form-control" name="article_id" id="article_id">
                    ...
                    <option value="{{ $article->id }}" {{ isset($banner) && $banner->article_id == $article->id
                        ? 'selected'
            ...
            <div class="form-group">
                ...
                <div class="mt-3 position-relative" style="display: inline-block;">
                    <img id="image-preview" src="{{ isset($banner) ? $banner->getFirstMediaUrl('banners') : '#' }}"
                        alt="Image Preview" class="img-thumbnail {{ isset($banner) ? '' : 'd-none' }}" width="300">
