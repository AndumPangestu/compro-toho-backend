...
<div class="card shadow mb-4">
    <div class="card-body">
        ...
        <img src="{{ $banner->getFirstMediaUrl('office_locations') }}" alt="Office Location Image" class="img-thumbnail"
            width="300">
        <br>
        ...
        <form method="POST"
            ...
            <div class="form-group">
                ...
                <textarea class="form-control @error('address') is-invalid @enderror" name="address" id="address"
                    ...
                    required>{{ isset($officeLocation) ? $officeLocation->address : old('address') }}</textarea>
                @error('address')
